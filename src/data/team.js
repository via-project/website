// Team roster, consumed by src/pages/Team.js.
...
export const leadership = [
  ...
  },
  {
    role: 'INSTRUMENT PI',
    people: [
      { name: 'Dan Fabricant', affil: 'CfA', url: 'https://www.cfa.harvard.edu/people/daniel-fabricant' },
    ],
  },
  {
    role: 'DEPUTY PROJECT SCIENTIST',
    people: [
      { name: 'Vedant Chandra', affil: 'CfA', url: 'https://vedantchandra.com/' },
    ],
  },
  {
    role: 'DEPUTY INSTRUMENT PI',
    people: [
      { name: 'Jack Piotrowski', affil: 'Carnegie', url: 'https://jack-piotrowski.com/' },
    ],
  },
];
