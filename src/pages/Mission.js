...
function Mission() {
  return (
    <>
      ...
      <Section bg="../img/mission_cosmicweb.jpg" overlay="gradient" inner="left-bottom">
      ...
      <Section bg="../img/dm_models_shade.jpg" inner="left-bottom">
      ...
      <Section bg="../img/ufd.jpg" inner="left-bottom">
        <h4 style={{textTransform:"uppercase", paddingBottom:"5px"}}>Science Pillar</h4>
      ...
      <Section bg="../img/outflow_schneider.jpg" overlay="gradient" inner="left-bottom">
        <h4 style={{textTransform:"uppercase", paddingBottom:"5px"}}>Science Pillar</h4>
