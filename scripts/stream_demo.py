...
# Locate <repo>/public/sim_data by walking up from the cwd, so this works
# whether run from scripts/, the repo root, or the data dir itself.
_root = Path.cwd()
while not (_root / 'public' / 'sim_data').is_dir() and _root != _root.parent:
    _root = _root.parent
outdir = _root / 'public' / 'sim_data'
decimals = 3
